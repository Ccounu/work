<template>
  <div class="page-container">
    <div class="page-header">
      <van-nav-bar fixed :title="formData.city + '行程规划'" left-text="返回" left-arrow @click-left="onBack" />
    </div>
    <div class="page-content">
      ...
      <template v-else-if="tripData && tripData.success !== false">
        ...
        <van-collapse v-model="activeDays" class="trip-collapse">
          <van-collapse-item v-for="day in tripData.dailyItinerary" :key="day.days" :title="'第' + day.day + '天'"
            :name="day.days">
...
onMounted(() => {
  const { city, budget, days } = router.currentRoute.value.query
  formData.city = city
