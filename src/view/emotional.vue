<template>
  <div>
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="moodScreRange" label="情绪评分" width="270">
        <template #default="scope">
          <el-rate :model-value="scope.row.moodScore" :max="10" disabled />
        </template>
      </el-table-column>
      <el-table-column prop="moodScreRange" label="生活指标" width="120">
        <template #default="scope">
          <div>
    ...
    <el-pagination style="margin-top: 25px" :page-size="pagination.size" @change="handleChange"
