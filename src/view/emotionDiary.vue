  ...
  <div class="emotionDiary-container">
    <div class="header-section">
      <div class="header-content">
        <el-image :src="iconUrl" alt="情绪日志" style="width: 60px; height: 60px;" />
        <h1>情绪日记</h1>
      </div>
    </div>
    <div class="content">
      ...
      <div class="diary-card">
        ...
        <div class="emotion-grid">
          <div v-for="emotion in emotionOptions" :key="emotion.name"
            :class="{ 'selected': emotion.name === diaryForm.dominantEmotion }" class="emotion-card"
            @click="selectEmotion(emotion.name)">
            <el-image :src="emotion.url" alt="情绪图标" style="width: 40px; height: 40px;" />
